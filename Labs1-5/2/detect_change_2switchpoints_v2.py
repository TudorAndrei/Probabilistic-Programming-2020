...
def lambda_(tau_1=tau_1, tau_2=tau_2, lambda_1=lambda_1, lambda_2=lambda_2, lambda_3=lambda_3):
    ...
    (t1, t2) = (tau_1, tau_2) if tau_1 < tau_2 else (tau_2, tau_1)
    out[:t1] = lambda_1  # lambda before tau is lambda1
    out[t1:t2] = lambda_2  # lambda before tau is lambda1
    out[t2:] = lambda_3  # lambda after (and including) tau is lambda2
    return out
